...
my $spec = Test::CPAN::Meta::JSON::Version->new(spec => '1.1');

is($spec->url('url','http://module-build.sourceforge.net/META-spec-v1.1.html'),1,'valid URL');
is($spec->url('url','http://'),0);
is($spec->url('url','test://module-build.sourceforge.net/META-spec-v1.1.html'),0);
...
is($spec->urlspec('spec','http://module-build.sourceforge.net/META-spec-v1.1.html'),1,'valid specification URL');
