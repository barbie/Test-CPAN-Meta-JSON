...
my $testfile = 't/samples/00-META.json';
die unless(-f $testfile);

test_out('ok 1 - t/samples/00-META.json contains valid JSON');
test_out('ok 2 - t/samples/00-META.json meets the designated specification (1.3)');
meta_spec_ok($testfile,'1.3');
test_test("$testfile with version 1.3");

test_out('ok 1 - t/samples/00-META.json contains valid JSON');
test_out('not ok 2 - t/samples/00-META.json meets the designated specification (1.2)');
test_fail(2);
...
test_out('ok 1 - t/samples/00-META.json contains valid JSON');
test_out('ok 2 - t/samples/00-META.json meets the designated specification (1.1)');
meta_spec_ok($testfile,'1.1');
test_test("$testfile with version 1.1");

test_out('ok 1 - t/samples/00-META.json contains valid JSON');
test_out('ok 2 - t/samples/00-META.json meets the designated specification (1.0)');
meta_spec_ok($testfile,'1.0');
test_test("$testfile with version 1.0");

test_out('ok 1 - t/samples/00-META.json contains valid JSON');
test_out('ok 2 - t/samples/00-META.json meets the designated specification');
